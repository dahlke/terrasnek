...
class TFCAdminSettings(TFCEndpoint):
    ...
    def __init__(self, instance_url, org_name, headers, verify):
        ...
        self._api_v2_base_url = f"{self._api_v2_base_url}/admin"
    ...
    def list_general(self):
        ...
        """
        url = f"{self._api_v2_base_url}/general-settings"
    ...
    def list_cost_estimation(self):
        ...
        """
        url = f"{self._api_v2_base_url}/cost-estimation-settings"
        return self._list(url)
    ...
    def list_saml(self):
        ...
        """
        url = f"{self._api_v2_base_url}/saml-settings"
        return self._list(url)
    ...
    def revoke_previous_saml_idp_cert(self):
        ...
        """
        url = f"{self._api_v2_base_url}/saml-settings/actions/revoke-old-certificate"
    ...
    def list_smtp(self):
        ...
        """
        url = f"{self._api_v2_base_url}/smtp-settings"
        return self._list(url)
    ...
    def list_twilio(self):
        ...
        """
        url = f"{self._api_v2_base_url}/twilio-settings"
        return self._list(url)
    ...
    def verify_twilio(self, data):
        ...
        """
        url = f"{self._api_v2_base_url}/twilio-settings/verify"
    ...
    def list_customization(self):
        ...
        """
        url = f"{self._api_v2_base_url}/customization-settings"
        return self._list(url)
