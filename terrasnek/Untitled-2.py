"""
Module for Terraform Cloud API Endpoint: Providers.
"""

from .endpoint import TFCEndpoint

class TFCProviders(TFCEndpoint):
    """
    `Providers API Docs \
    ...
    def show(self, task_id):
        ...
        `Providers Show API Doc Reference \
    ...
    def destroy(self, task_id):
        ...
        `Providers Destroy API Doc Reference \
